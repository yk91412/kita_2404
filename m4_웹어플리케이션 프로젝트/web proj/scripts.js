...
function validation(){
    const search_keyword = nvl(document.getElementById('search_keyword').value);
    ...
    const start_date = nvl(document.getElementById('start_date').value);
    const end_date  = nvl(document.getElementById('end_date').value);
