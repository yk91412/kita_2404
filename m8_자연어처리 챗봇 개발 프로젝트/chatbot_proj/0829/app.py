...
from function import get_user, create_user, save_chat, get_chat_history,\
...
def show_summary(summary_id):
    ...
    if user_id:
        ...
        session['chat_history'] = chat_history
        session['summary_id'] = summary_id  # 클릭한 summary_id를 세션에 저장
...
def logout():
    ...
    # 로그아웃 시
    session.pop('sidebar_visible', None)
